        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gray-900 rounded-2xl">
          <div className="p-3 mx-auto text-center text-white sm:p-4 max-w-xs sm:max-w-md">
            <div className="mb-2 sm:mb-3">
              <svg
                className="mx-auto w-8 h-8 sm:w-10 sm:h-10 text-violet-400"
                fill="currentColor"
                viewBox="0 0 24 24">
            ...
            <button
              ...
              className="px-4 py-2 w-fit text-xs font-semibold text-white rounded-lg transition-all duration-300 transform sm:text-sm bg-gradient-to-r from-violet-500 to-indigo-600 hover:from-violet-600 hover:to-indigo-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-gray-900"
